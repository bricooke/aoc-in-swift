...
* added a [justfile](https://github.com/casey/just). start a new day with `just create 03` (where 03 is the day number). No need to manually copy files and add to the all cases array. h/t to https://github.com/ChristopherBiscardi/advent-of-code)
* copy your input to Sources/Data/Day{X}.txt
* implement solution in Sources/Day{x}.swift and use Tests/Day{x}.swift to run tests with simpler input.

-------- BELOW IS ALL FROM THE ORIGINAL [REPO](https://github.com/apple/swift-aoc-starter-example) ------
